...
class NLQueryExecutor:
    ...
    def __init__(self, db_type: str = "mysql", kg: Optional["KnowledgeGraph"] = None, use_llm: bool = False):
        ...
        self.generator = NLSQLGenerator(db_type, kg=kg, use_llm=use_llm)  # Pass KG and use_llm to generator
...
def get_nl_query_executor(db_type: str = "mysql", kg: Optional["KnowledgeGraph"] = None, use_llm: bool = False) -> NLQueryExecutor:
    """
