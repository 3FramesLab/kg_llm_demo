-- =====================================================
-- Comprehensive Seed Data for 500 Items (GPU & NBU)
-- Based on newdqschemanov.json schema analysis
-- =====================================================
...
-- =====================================================
-- 1. HANA MATERIAL MASTER (Master Data)
-- =====================================================

-- Clear existing data
TRUNCATE TABLE hana_material_master;

-- Create a simple numbers table for generating 500 records
...
-- Insert 500 records (250 GPU + 250 NBU)
WHILE @Counter <= 500
BEGIN
    INSERT INTO @TempData (RowNum, ProductType)
    VALUES (
        @Counter,
        CASE WHEN @Counter <= 250 THEN 'GPU' ELSE 'NBU' END
    );
    SET @Counter = @Counter + 1;
END;
-- Now insert the data using the temp table
