-- =====================================================
-- Create Separate KPI Database in MS SQL Server (FIXED)
-- Dedicated database for KPI definitions and execution results
-- Fixed computed column syntax issue
-- =====================================================
...
PRINT '=== Creating Separate KPI Database (Fixed Version) ===';
...
-- KPI Execution Results Table (Fixed computed columns)
...
-- =====================================================
-- 3. Add Computed Columns (Fixed Syntax)
-- =====================================================
...
PRINT '✓ Added computed columns for analytics optimization';

-- =====================================================
-- 4. Create Analytics-Optimized Indexes
-- =====================================================
...
-- Insert a test execution for the first KPI
...
WHERE database_id = DB_ID('KPI_Analytics');
...
PRINT '';
PRINT '=== KPI Analytics Database Creation Complete (Fixed) ===';
...
PRINT 'Computed Columns: execution_date, execution_hour (FIXED)';
PRINT '';
